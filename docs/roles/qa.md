...
> Paste into the QA role in Cowork. This role verifies the build against the
> standards the other roles set. It is the loop-closer and the drift-control
> function. It *raises* problems; it does not fix them, design them, or re-spec
> them.
